 ...
 */
package ca.uqac.lif.toolbox.time;

import ca.uqac.lif.toolbox.objects.Resettable;
import ca.uqac.lif.toolbox.objects.Startable;
import ca.uqac.lif.toolbox.objects.Stoppable;
 ...
 */
public class WallClock implements Clock, Startable, Stoppable, Resettable
{
	/**
	...
	/**
	 * Creates a new clock set at an arbitrary time.
	 * @param start_time The time in milliseconds
	 * @param start Set to {@code true} to automatically start the clock after
	 * initialization, {@code false} otherwise
	 */
	public WallClock(long start_time, boolean start)
	{
		super();
	...
	/**
	 * Creates a new clock set at the current system time.
	 * @param start Set to {@code true} to automatically start the clock after
	 * initialization, {@code false} otherwise
	 */
	public WallClock(boolean start)
	{
		this(getCurrentRealTime(), start);
	}
	 ...
	 */
	@Override
	/*@ non_null @*/ synchronized public void reset()
	{
	 ...
	 */
	@Override
	/*@ non_null @*/ synchronized public void stop()
	{
		if (!m_stopped)
		{
	 ...
	 */
	@Override
	/*@ non_null @*/ synchronized public void start()
	{
		if (m_stopped)
		{
